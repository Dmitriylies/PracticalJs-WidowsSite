...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_5__["default"])('.container1', '2021-07-29');
...
var changeModalState = function changeModalState(state) {
  var windowForm = document.querySelectorAll('.balcon_icons_img'),
      //узнаем на какое эл. кликнул пользователь
  windowWidth = document.querySelectorAll('#width'),
      windowHeight = document.querySelectorAll('#height'),
      windowType = document.querySelectorAll('#view_type'),
      windowProfile = document.querySelectorAll('.checkbox'); //холодное/теплое

  Object(_checkNumInputs__WEBPACK_IMPORTED_MODULE_1__["default"])(['#width', '#height'], '.popup_calc_button');
  Object(_checkNumInputs__WEBPACK_IMPORTED_MODULE_1__["default"])('.checkbox', '.popup_calc_profile_button');
  Object(_checkNumInputs__WEBPACK_IMPORTED_MODULE_1__["checkNum"])(['#width', '#height']);
...
/*!******************************************!*\
  !*** ./src/js/modules/checkNumInputs.js ***!
  \******************************************/
/*! exports provided: default, checkNum */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var checkNumInputs = function checkNumInputs(selector, triggerSelector) {
...
var forms = function forms(state) {
  var form = document.querySelectorAll('form'),
      input = document.querySelectorAll('input'); //*6

  Object(_checkNumInputs__WEBPACK_IMPORTED_MODULE_5__["checkNum"])('input[name="user_phone"]'); //*2
...
var images = function images() {
  var worksParent = document.querySelector('.works');
  ...
  worksParent.addEventListener('click', function (e) {
    e.preventDefault();
    var target = e.target;
    ...
    if (target && target.classList.contains('preview')) {
      ...
      bigImg.style.width = "".concat(height, "px");
    }
...
var modals = function modals() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    var openModal = function openModal(selector) {
      selector.classList.add('show'); //document.body.style.owerflow = "hiiden";

      document.body.classList.add('modal-open');
    };

    var closeModal = function closeModal() {
      modal.classList.remove('show'); //document.body.style.owerflow = "";
  ...
  function showModalByTime(selector, time) {
    setTimeout(function () {
      document.querySelector(selector).classList.add('show'); //document.body.style.owerflow = "hiiden";
...
var timer = function timer(id, deadline) {
  var getTimeRemainding = function getTimeRemainding(endtime) {
  ...
  var setTimeRemainding = function setTimeRemainding(selector, endtime) {
    ...
    function upDateClock() {
      var t = getTimeRemainding(endtime);
